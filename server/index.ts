...
function setupCors(app: express.Application) {
  app.use((req, res, next) => {
    const configuredOrigins = (process.env.CORS_ORIGIN || process.env.EXPO_PUBLIC_DOMAIN || "")
      .split(",")
...
(async () => {
  ...
  app.get("/api/health", (_req, res) => res.json({ ok: true, app: "MansaMart", time: new Date().toISOString() }));
